...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=108937&x=SEKXLEN&y=SEKYLEN&cbuster=1655724409',
					origQString: 's=108937',
					placementId: 108937,
					x: 608,
					y: 342,
					videoType: 'normal',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"102.0.0.0","browserVersionMajor":"102","browserVersionMinor":"0","chromeVersion":"102"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [["floatSetup",[{"screenWidthSize":"1900","enabled":1,"width":"400","direction":"bl","verticalOffset":"51","horizontalOffset":"0","isCloseBtn":1,"flowMode":"seenboth","closeBtnPos":"right","height":225},{"screenWidthSize":"1","enabled":0,"width":"300","direction":"bl","verticalOffset":"5","horizontalOffset":"10","isCloseBtn":1,"flowMode":"below","closeBtnPos":"right","height":169}]]],
					uuid: '62b0596cefbaf',
					...
					customTargetingProperties: {"objectType":"window.top","objectFunction":"getPrimisTargeting()"},
